...
class CcViewSharingsUsersTable extends SupabaseTable<CcViewSharingsUsersRow> {
  @override
  String get tableName => 'cc_view_sharings_users';

  @override
  CcViewSharingsUsersRow createRow(Map<String, dynamic> data) =>
      CcViewSharingsUsersRow(data);
}

class CcViewSharingsUsersRow extends SupabaseDataRow {
  CcViewSharingsUsersRow(super.data);

  @override
  SupabaseTable get table => CcViewSharingsUsersTable();
